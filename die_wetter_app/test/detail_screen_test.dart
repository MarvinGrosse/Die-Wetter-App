...
Future<void> main() async {
  ...
  WeatherData weatherData = WeatherData(
      await fakeWeatherFactory.currentWeatherByCityName('Stuttgart'),
      await fakeWeatherService.getDailyForecastFiveDays('Stuttgart'),
      [],
      Location(id: 'DADSDA', name: 'Stuttgart'));

  testWidgets('Test Detail Screen', (tester) async {
    await mockNetworkImagesFor(() async {
      ...
      final screenTitle = find.text('Stuttgart');
